...
<img src="{{ '/assets/day44/RTL_View_tool.png' | relative_url }}" width="700">

<!-- ![alt text](../assets/day44/RTL_Diagram.png) -->
<img src="{{ '/assets/day44/RTL_Diagram.png' | relative_url }}" width="700">

## 🟩 Technology Map Viewer  
<!-- ![alt text](../assets/day44/Post_mapping.png) -->
<img src="{{ '/assets/day44/Post_mapping.png' | relative_url }}" width="700">

<!-- ![alt text](../assets/day44/Post_fitting.png) -->
<img src="{{ '/assets/day44/Post_fitting.png' | relative_url }}" width="700">
